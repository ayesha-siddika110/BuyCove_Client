        ...
        >
            ...
            <div className='w-[90%] h-full m-auto flex justify-center items-center'>
                ...
                <form  className=' bg-white bg-opacity-25  w-[100%] md:w-[50%] lg:w-[40%]  lg:p-10 p-5 space-y-5'>
                    <p className='text-4xl text-center text-white font-semibold uppercase'>Login Now<span className={"text-orange-600"}>!</span></p>
                    ...
                    <div>
                        <button className='bg-orange-600 w-full text-center py-3 text-white mt-3'>Login</button>
